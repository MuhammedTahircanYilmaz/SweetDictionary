...
namespace SweetDictionary.Service.Roles.Services.Concretes;
...
public sealed class RoleService : IRoleService
{
    ...
    public async Task<string> AddRoleToUser(AddRoleToUserRequestDto dto)
    {
        //Rol kontrolü
        ...
        return "Kullanıcıya rol eklendi : " + dto.RoleName;
    }
